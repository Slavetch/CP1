...
$subject ="Новая заявка с сайта slavetch.github.io.Julia";
...
$header .= "From: Новая заявка <slavech55@gmail.com>\n\n";	
$mail = mail("slavech55@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
